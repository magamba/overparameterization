...
# ResNet18s of increasing base width, following Nakkiran et al. 2019
resnet18_increasing_widths = {
    "resnet18_" + str(width): partial(ResNetBuilder, ResNetNoBN, BasicBlock, [2, 2, 2, 2], inplanes=width, channels=(2*width, 4*width, 8*width)) for width in range(1,65)
}
